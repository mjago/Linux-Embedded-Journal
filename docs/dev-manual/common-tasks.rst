...
Running ``recipetool create -oÂ OUTFILE`` creates the base recipe and
...
``bitbake -e``Â recipe commands includes the following information:
...
-  ``oe-pkgdata-util list-pkg-filesÂ packageÂ ...``: Lists the
...
-  ``oe-pkgdata-util find-pathÂ pathÂ ...``: Lists the names of
...
-  ``oe-pkgdata-util lookup-recipeÂ packageÂ ...``: Lists the name
...
BitBake command-line options::
   ...
   â€â€dump-signatures=SIGNATURE_HANDLER
   -S SIGNATURE_HANDLER
...
7. *Debug a program:*
   ...
   .. code-block:: shell
      ...
      root@qemux86:~# gdbserver localhost:1234 /bin/gzip â€”help
